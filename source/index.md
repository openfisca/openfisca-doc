...
* [Contribute](/doc/contribute/index.html) to an existing system by adding or improving elements of the legislation

How to turn legal code into Python code?

* First, identify some legislation that can be expressed as an arithmetic operation.
* Then, try to translate them into [formulas, variables, parameters, etc.](/doc/coding-the-legislation/index.html)
* You can even [build some tests](/doc/coding-the-legislation/writing_yaml_tests.html) to verify your implementation of the law.
...
With OpenFisca, you can [run a simulation](/doc/simulate/index.html) on a single situation or on a whole population. OpenFisca doesn’t provide any data, the data you need depends on what you’re trying to calculate.
...
* If you’re working on your thesis, you’ll rather use our [Python API](/doc/openfisca-python-api/index.html).
...
Please make sure you read our [licence information](/doc/licence.html) before using results based on OpenFisca.
...
* OpenFisca is contributive: if the legislation you need is not described yet, you’re the best person to add it (take a look at our [contribution guidelines](/doc/contribute/index.html)).
